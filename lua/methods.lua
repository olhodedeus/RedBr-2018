...
-- ban block 1
function api.banUserb(chat_id, user_id)
...
function api.desmuteUser(chat_id, user_id)

	local url = BASE_URL..'/restrictChatMember?chat_id='..chat_id..'&user_id='..user_id ..'&can_send_messages=true'..'&can_send_media_messages=true'..'&can_send_other_messages=true'..'&can_add_web_page_previews=true'
...
-- teste document
function api.sendDocument2(chat_id, document, reply_to_message_id, caption)
