...
local function do_keyboard_flood(chat_id)
	...
	local exceptions = {
		...
		gif = i18n("GIFs"),
		video = i18n("Videos"),
		audio = i18n("MP3"),--tem nao
    document = i18n("Documents"), --tem nao
		voice = i18n("Vocal messages"), -- tem nao
	  contact = i18n("Contacts"), -- tem não
		game = i18n("Games"), -- tem não
		location = i18n("Locations"), -- tem não
	}
...
It is also possible to choose which type of messages
the antiflood will ignore (✅)
]])
