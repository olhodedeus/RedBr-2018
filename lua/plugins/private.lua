...
Group Butler wouldn't exist without it. The owner of this bot is @baconn,do not pm him: use /groups command instead.

Bot version: `%s` *Some useful links:*
